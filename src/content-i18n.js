(() => {
  ...
  const UiMessage = Object.freeze({
    ...
    FAVORITES_SOURCE_LABEL: "favoritesSourceLabel",
    FAVORITES_FOLDERS_LABEL: "favoritesFoldersLabel",
    FAVORITES_CHOOSE_LABEL: "favoritesChooseLabel",
    FAVORITES_SEARCH_LABEL: "favoritesSearchLabel",
    FAVORITES_SEARCH_VIDEOS_LABEL: "favoritesSearchVideosLabel",
    FAVORITES_REFRESH_LABEL: "favoritesRefreshLabel",
    FAVORITES_SIGN_IN_LABEL: "favoritesSignInLabel",
    FAVORITES_SIGN_IN_MESSAGE: "favoritesSignInMessage",
    FAVORITES_ERROR_MESSAGE: "favoritesErrorMessage",
    FAVORITES_REFRESH_ERROR_MESSAGE: "favoritesRefreshErrorMessage",
    FAVORITES_NO_FOLDERS_MESSAGE: "favoritesNoFoldersMessage",
    FAVORITES_NO_MATCHES_MESSAGE: "favoritesNoMatchesMessage",
    FAVORITES_EMPTY_MESSAGE: "favoritesEmptyMessage",
    ...
    SOURCE_MORE_BUTTON_LABEL: "sourceMoreButtonLabel",
